...
def creature_data_gain(path):
    ...
    df = pd.read_csv(path + 'csv/dataset.csv', encoding='shift-jis')
    df2 = pd.read_csv(path + 'csv/class_sum.csv', encoding='shift-jis')
...
if __name__ == "__main__":
    ...
    creature_data_gain(config['creature_data_destination'])
