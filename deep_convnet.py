...
class DeepConvNet:
    ...
    def __init__(self, input_dim=(1, 192, 192),
                 ...
                 conv_param_4 = {'filter_num':8, 'filter_size':3, 'pad':1, 'stride':1},
        ...
        pre_node_nums = np.array([1*3*3, 4*3*3, 4*3*3, 8*3*3, 8*3*3, 16*3*3, 16*24*24, hidden_size])
        ...
        self.params['W7'] = weight_init_scales[6] * np.random.randn(16*24*24, hidden_size)
